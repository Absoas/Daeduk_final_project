...
<!--              	로그인 -->
                <ul class="header__login">
                    <li>
                    	<button style="color: red;" value="기업" onclick="location.href='${pageContext.request.contextPath}/signup/member.do'"></button>
                    </li>
                    
                    <li>
                     	<button  style="color: red;" value="회원" onclick="location.href='${pageContext.request.contextPath}/login/loginCheck.do'"></button>
                    </li>
...
<!--              	기업 회원 -->
             	<ul class="header__social">
                    <li>
                    	<button style="color: red;" value="기업" onclick="location.href='${pageContext.request.contextPath}/cor/mainPage.do'"></button>
                    </li>
                    
                    <li>
                     	<button  style="color: red;" value="회원" onclick="location.href='${pageContext.request.contextPath}/admin/mainPage.do'"></button>
                    </li>
